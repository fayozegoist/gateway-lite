...
Menerima koneksi HTTP/WebSocket di suatu port dan meneruskannya ke
Dropbear SSH (127.0.0.1:22). Termasuk filter untuk sisa payload HTTP
PATCH dari klien HTTP-Custom agar tidak merusak banner SSH.
"""
